...
- **⚡ 속도전 (실시간 멀티)**: 캐치마인드·끄투식 동시 풀이. 공개 방 목록에서 입장하거나 직접 방을 만들고(문항 10/20/30 · 제한 10/15/20/30초), 최대 8명이 **같은 문제를 동시에** 받아 먼저 정답을 타이핑한 사람이 고득점
  ...
  - 출제는 **주관식 이름 맞히기 5종**(실루엣·울음소리·확대·도감설명·랜덤 힌트)만. 객관식은 찍어도 0.3초에 눌려 속도 경쟁이 운으로 흐른다
  ...
  - 한국어·영어 유저가 같은 방에 섞여도 **양쪽 언어 이름을 모두 정답 인정**하고, 지문은 각자 자기 언어로 렌더링한다(도감설명·힌트 본문만 호스트 언어)
