...
//     · 특성 변경 2건 — Unseen Fist(방어 관통 데미지 100% → 25%), 치유의마음(Healer, 발동 30% → 50%).
//       둘 다 이 은행에 문항이 없어 영향 없다. ※ Serebii /updatedabilities 에는 Unseen Fist만 실려 있고
//       Healer는 Bulbapedia(Pokémon Champions 문서 + Healer 문서)에만 있다 — 새로 문항을 만들 땐 재확인할 것.
